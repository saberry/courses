...
Sentiment analysis is commonly used when we want to know the general *feelings* of what someone has written. Sentiment analysis is commonly seen applied to Twitter and other social media posts, but we can use it anywhere where people have written something: Amazon and Yelp reviews, Course Instructor feedback forms, and song lyrics.
