...
data.frame(Week = c(1:7),
           Topic = c("Introduction/Probability", 
                     ...
                     "Optimization", 
                     "AI"), 
           Article = c("Is Data Science the Fourth Pillar of the Scientific Method?", 
                       "Do You Understand The Variance In Your Data?", 
                       "", 
                       "A/B Testing: How Retailers Can Optimize\nTheir Sales With Experimentation", 
                       "", 
                       "Don't Just Analyze Your Business, Optimize It", 
                       "This High-Tech Solution to Disaster\nResponse May Be Too Good to Be True")) %>% 
  knitr::kable(., format = "latex") %>% 
  kable_styling(latex_options = "striped")
