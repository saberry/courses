...
At time, you will get data in some proprietary format. That is when you need to turn to other places.
...
This is where the benefit of <span class="pack">tidyverse</span> become clear. 
