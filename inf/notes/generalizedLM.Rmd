...
```{r}
ggplot() +
  geom_col(data = data.frame(x = 1:30, y = dpois(1:30, (1 / 7) * 28)), 
           mapping = aes(x, y), width = .97, alpha = .25, fill = "red") +
  geom_col(data = data.frame(x = 1:30, y = dpois(1:30, (3 / 7) * 28)), 
           mapping = aes(x, y), width = .97, alpha = .25, fill = "blue") +
  geom_col(data = data.frame(x = 1:30, y = dpois(1:30, (5 / 7) * 28)), 
