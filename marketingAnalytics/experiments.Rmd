...
## On Power {data-transition="convex"}
...
Does anybody remember that regression issue when values on your outcome can change for a variable based upon the values for another variable?
