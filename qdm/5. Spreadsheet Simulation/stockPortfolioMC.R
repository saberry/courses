...
potentialSymbols = c("FB", "TSLA", "PYPL", "SNAP", "SIRI", "AMD", 
                     "SPY","EFA", "IJS", "EEM","AGG")

symbols = c("FB", "TSLA", "PYPL", "SNAP", "SIRI")
...
monte_carlo_sim_51 = map_dfc(starts, simulation_accum_1, 
          N = 120, mean = mean_port_return, 
          stdev = stddev_port_return)

monte_carlo_sim_51 = monte_carlo_sim_51 %>% 
...
monte_carlo_rerun_51 = rerun(.n = reruns, 
                             simulation_accum_1(1, 120, mean_port_return, 
                                                stddev_port_return)) %>%
  simplify_all() %>% 
