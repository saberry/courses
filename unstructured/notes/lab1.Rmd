...
The following code for `ctRatings` will not likely work. While the order of the selectors is correct, the characters (e.g., 373c0) seem to change almost daily.
