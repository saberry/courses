...
<aside>
You will notice that we pretty much ran the same code three times -- probably time to create a function.
</aside>
...
companyData <- data.frame(name = c("Pepsi Co.", ))
```

Before we try to join these data frames, I want to introduce you to my favorite string distance measures: Jaro Winkler.
